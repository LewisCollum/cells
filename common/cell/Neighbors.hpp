...
namespace cell {
    ...
    public:
        ...
        value_pointer getEast() const { return east; }
        value_pointer getWest() const { return west; }
        value_pointer getNorth() const { return north; }
        value_pointer getSouth() const { return south; }

        auto size() { return neighbors.size(); }
        auto begin() const -> decltype(neighbors.begin()) { return neighbors.begin(); }
        auto end() const -> decltype(neighbors.end()) { return neighbors.end(); }
